...
print(Fore.YELLOW + Style.DIM + "SPEED: ", Fore.WHITE + Style.NORMAL + str(fan_1.get_speed()), "[fast]")    #speed
print(Fore.YELLOW + Style.DIM + "RADIUS:", Fore.WHITE + Style.NORMAL + str(fan_1.get_radius()))             #radius
print(Fore.YELLOW + Style.DIM + "COLOR: ", Fore.WHITE + Style.NORMAL + str(fan_1.get_color()))              #color
